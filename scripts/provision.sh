...
mounts = [
  { host_path = "../ai-ks-vue/code", container_path = "/work/vue", read_only = false },
  { host_path = "../ai-ks-fastapi/code", container_path = "/work/fastapi", read_only = false },
]
EOF
echo "  已写入 external_port 与前后端 code 挂载（容器内 /work/vue、/work/fastapi）"
